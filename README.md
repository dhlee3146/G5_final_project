...
| 2024.05.28     | 😎 Coder wrote the sample2
+ CD made video for preview at 2.p.m<br>Video: Image source = Playground (AI Image generating site)<br>Quiz using Multiple question: Use Chat GPT to make Instruction box.<br>Read-Aloud Practice APP based on text-to-audio by sentence app |                                                                                        |
...
### Platform we will use for the class
+ Padlet link and look at the colunm "Group 5" 

[Link] https://padlet.com/mirankim316/digital-literacy-and-english-education-spring-2024-2gmo48o5djxsjpqa 
